// Package websitetotext provides a Go client for the Website to Text API.
//
// For more information, visit: https://apiverve.com/marketplace/websitetotext?utm_source=go&utm_medium=readme
package websitetotext
...
// Request contains the parameters for the Website to Text API.
//
// Parameters:
//   - url (required): string - The URL of the website to convert to text [format: url]
type Request struct {
...
// ResponseData contains the data returned by the Website to Text API.
