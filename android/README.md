...
```gradle
dependencies {
    implementation 'com.github.apiverve:websitetotext-api:1.1.13'
}
```
...
```java
import com.apiverve.websitetotext.WebsitetoTextAPIClient;
import com.apiverve.websitetotext.APIResponse;
import com.apiverve.websitetotext.APIException;

// Initialize the client
WebsitetoTextAPIClient client = new WebsitetoTextAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/websitetotext](https://docs.apiverve.com/ref/websitetotext)
...
- **Documentation:** [https://docs.apiverve.com/ref/websitetotext](https://docs.apiverve.com/ref/websitetotext)
- **Issues:** [GitHub Issues](https://github.com/apiverve/websitetotext-api/issues)
