...
namespace APIVerve.API.WebsitetoText
{
    ...
    /// <summary>
    /// Client for the WebsitetoText API
    /// </summary>
    public class WebsitetoTextAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/websitetotext";
        ...
        public WebsitetoTextAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsitetoTextAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebsitetoTextAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WebsitetoTextQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WebsitetoTextQueryOptions options)
        {
        ...
        public ResponseObj Execute(WebsitetoTextQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WebsitetoTextQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WebsitetoTextQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WebsitetoTextQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WebsitetoTextQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WebsitetoTextQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WebsitetoTextQueryOptions options)
        {
